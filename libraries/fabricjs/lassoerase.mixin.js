(function () {
  ...
  fabric.util.object.extend(fabric.Object.prototype, {
    /**
     * Indicates whether this object can be erased by {@link fabric.LassoEraserBrush}
  ...
  fabric.util.object.extend(fabric.Group.prototype, {
    ...
    _addEraserPathToObjects: function (path) {
      this._objects.forEach(function (object) {
        fabric.LassoEraserBrush.prototype._addPathToObjectEraser.call(
          fabric.LassoEraserBrush.prototype,
          object,
          path
        );
      });
            ...
            .forEach(function (path) {
              ...
              if (clipPath) {
                clipPath.clone(function (_clipPath) {
                  fabric.LassoEraserBrush.prototype.applyClipPathToPath.call(
                    fabric.LassoEraserBrush.prototype,
                    path,
                    _clipPath,
                    transform
   ...
   * @class fabric.LassoEraserBrush
   * @extends fabric.PencilBrush
   */
  fabric.LassoEraserBrush = fabric.util.createClass(
    fabric.PencilBrush,
    /** @lends fabric.LassoEraserBrush.prototype */ {
      type: 'eraser',

      /**
       * Indicates that the ctx is ready and rendering can begin.
       * Used to prevent a race condition caused by {@link fabric.LassoEraserBrush#onMouseMove} firing before {@link fabric.LassoEraserBrush#onMouseDown} has completed
       *
       * @private
       */
      _ready: false,
       ...
       * {@link fabric.LassoEraserBrush#hideObject}
       * @param {fabric.Object} object
       */
       ...
       * Used by {@link fabric.LassoEraserBrush#prepareCanvasObjectsForLayer}
       ...
       * @private
       * Used by {@link fabric.LassoEraserBrush#prepareCanvasObjectsForLayer}
       * to reverse the action of {@link fabric.LassoEraserBrush#prepareCollectionTraversal}
       *
       * @param {fabric.Collection} collection
       */
      ...
      */
       ...
       * 1. Draw all non-erasable objects on bottom ctx with the exception of overlays {@link fabric.LassoEraserBrush#renderBottomLayer}
       * 2. Draw all objects on top ctx including erasable drawables {@link fabric.LassoEraserBrush#renderTopLayer}
       * 3. Draw eraser {@link fabric.PencilBrush#_render} at {@link fabric.LassoEraserBrush#renderTopLayer}
       * 4. Draw non-erasable overlays {@link fabric.LassoEraserBrush#renderOverlay}
       *
